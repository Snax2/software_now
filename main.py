...
# Call the function with the actual folder path:
folder_path = '/Users/snax/Desktop/Question 1/Data'
...
# Load spaCy model
nlp = spacy.load("/Users/snax/Downloads/en_core_sci_sm-0.5.3")

# Read the content from combined_text.txt in chunks
text_chunks = read_text_in_chunks('combined_text.txt', window_size=100000, overlap=20000)
...
# Load spaCy model
nlp = spacy.load("/Users/snax/Downloads/en_ner_bc5cdr_md-0.5.3/en_ner_bc5cdr_md/en_ner_bc5cdr_md-0.5.3")
